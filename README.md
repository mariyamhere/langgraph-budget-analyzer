...
I made this automated budget analyzer to help me track my expenses. To use this, you add all your yearly expense invoices into a folder in your project's base directory, it prompts you to add your yearly budget in the terminal and then it tells you how much of your budget you've exhausted (also with a chart) and which your top paid vendors are this year.
